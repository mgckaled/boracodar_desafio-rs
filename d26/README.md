...
**Desafio da Semana**: Desenvolva a versão web de uma experiência de receita junina. Use sua criatividade para ir além.
...
Aprecie o resultado do desafio [`AQUI`](https://mgckaled.github.io/boracodar_desafios-rs/d26/template/).
