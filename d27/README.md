...
# `Desafio #27 - Página de erro 404`

**Desafio da Semana**: Desenvolva página de erro 404 (página não encontrada), com animação. Use sua criatividade e fique à vontade para ir além.
...
Aprecie o resultado do desafio [`AQUI`](https://mgckaled.github.io/boracodar_desafios-rs/d27/template/).
